...
const DeviceDetail = () => {
  ...
  return (
    <div className="space-y-lg">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className={`flex items-center gap-2 px-3 py-1 rounded-DEFAULT border ${
            ...
            <span className="font-label text-label uppercase tracking-widest">
              {isAnomaly ? 'Anomaly Detected' : 'Operational'}
            </span>
          </div>
        </div>
        <div className="font-data-sm text-data-sm text-outline flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">
        {/* Sound Energy */}
        <div className="glass-card p-md rounded-lg flex flex-col justify-between h-32 relative overflow-hidden group hover:border-white/30 transition-all duration-300">
          <div className="flex justify-between items-start">
