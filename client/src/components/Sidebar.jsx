      ...
      >
        ...
        <div className="flex items-center justify-between p-gutter border-b border-white/10">
          <div className="flex items-center gap-sm">
            ...
            <span className="text-sm font-black text-blue-400 normal-case tracking-normal">
              Digital Ear
            </span>
          </div>
          <button
        ...
        <div className="p-gutter border-b border-white/10">
          <div className="flex items-center gap-sm">
            ...
            <div>
              ...
              <div className="font-data-sm text-outline-variant text-[10px]">
                Station 04 - Active
              </div>
            </div>
          </div>
        ...
        {/* Nav links */}
        <div className="flex-1 overflow-y-auto py-sm">{navLinks}</div>
